...
export default class UserEdit extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:5001/api/users?id='+this.props.match.params.id)
            ...
            axios.get('http://localhost:5001/showroles/')
            .then(response => {
    ...
    delete(id){
      console.log(id);
      axios.delete('http://localhost:5001/user?id='+this.props.match.params.id)
        .then((result) => {
    ...
    onSubmit = (e) => {
        ...
        axios.put('http://localhost:5001/user?id='+this.props.match.params.id, {first_name, last_name, email, password, role})
        .then((result) => {
          this.props.history.push("/allusers/")
        });
    }
